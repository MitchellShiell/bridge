...
<Tabs>
  ...
  <TabItem value="scoreDev" label="ScoreDev">
     ![Score Dev](../03-Score/assets/scoreDev.svg 'Score Dev Environment')
  </TabItem>
  <TabItem value="maestroDev" label="MaestroDev">
     ![Maestro Dev](../04-Maestro/assets/maestroDev.svg 'Maestro Dev Environment')
  </TabItem>
  <TabItem value="arrangerDev" label="ArrangerDev">
     ![Arranger Dev](../05-Arranger/assets/arrangerDev.svg 'Arranger Dev Environment')
  </TabItem>
  <TabItem value="stageDev" label="StageDev">
    ![Stage Dev](../06-Stage/assets/stageDev.svg 'Stage Dev Environment')
  </TabItem>
</Tabs>
